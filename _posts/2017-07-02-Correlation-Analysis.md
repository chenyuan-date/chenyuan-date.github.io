...
![](/images/Correlations-unnamed-chunk-2-1.png)<!-- -->
...
![](/images/Correlations-unnamed-chunk-2-2.png)<!-- -->

```r
ggqqplot(mtcars$wt, ylab = "WT")
```

![](/images/Correlations-unnamed-chunk-2-3.png)<!-- -->
...
![](/images/Correlations-unnamed-chunk-8-1.png)<!-- -->
...
![](/images/Correlations-unnamed-chunk-9-1.png)<!-- -->
...
![](/images/Correlations-unnamed-chunk-10-1.png)<!-- -->
...
![](/images/Correlations-unnamed-chunk-11-1.png)<!-- -->

# Partial correlation 
The R package ppcor provides users with four functions: pcor(), pcor.test(), spcor(), and spcor.test().     
`pcor()` (spcor()) calculates the partial (semi-partial) correlations of all pairs of two random variables of a matrix or a data frame and provides the matrices of statistics and p-values of each pairwise partial (semi-partial) correlation.    
`pcor.test()` ( spcor.test()) computes the pairwise partial (semipartial) correlation coefficient of a pair of two random variables given one or more random variables.      
...
![](/images/Correlations-unnamed-chunk-12-1.png)<!-- -->

```r
#If warning like this: "Error in solve.default(cvx) : system is computationally singular: reciprocal condition number = 3.60323e-19", means "more variables than observations, in which case your design matrix is probably not full rank."
```
